<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
    <li class="nav-item">
        <a class="nav-link <?= $_GET['page'] == 'edit_user' ? 'active' : '' ?>" href="?page=edit_user">จัดการสมาชิก</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?= $_GET['page'] == 'edit_org' ? 'active' : '' ?>" href="?page=edit_org">จัดการข้อมูลองค์กร</a>
    </li>
    <li class="nav-item">
